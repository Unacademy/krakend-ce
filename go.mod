...
go 1.17 // Changed from 1.12 to 1.17
...
require (
	...
	github.com/unacademy/krakend-auth v1.1.0-dev.5.12
	github.com/unacademy/krakend-sse v1.1.0
...
require github.com/unacademy/krakend-websocket v1.2.1-0.20250816085149-e233f3adff0e
